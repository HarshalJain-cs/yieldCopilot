export interface GlossaryTerm {
  term: string;
  fullName?: string;
  category: "basics" | "stablecoins" | "protocols" | "yields" | "risk" | "advanced";
  definition: string;
  example?: string;
  keyPoints?: string[];
  relatedTerms?: string[];
...
export const glossaryTerms: GlossaryTerm[] = [
  ...
  },
  {
    ...
    keyPoints: ["This doesn't apply to single-asset lending on Aave—only to liquidity pools."],
  ...
  // === ADVANCED ===
  {
    ...
    example: "Hold an asset long AND short it equally. Price goes up? Long gains, short loses—net zero. Price goes down? Long loses, short gains—still net zero.",
  ...
  },
  {
    ...
    keyPoints: ["When more people are long than short, longs pay shorts a 'funding fee' (and vice versa). This is how USDe generates extra yield."],
  ...
  },
  {
    ...
    keyPoints: ["Protects users from flash crashes that would cause full liquidation in other protocols."],
