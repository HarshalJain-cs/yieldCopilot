  ...
  assets: [
    {
      ...
      description: "The most trusted stablecoin in DeFi. Backed 1:1 by US dollars held in regulated financial institutions.",
      keyPoints: [
    ...
    },
    {
      ...
      riskLevel: "low" as const,
      description: "The largest stablecoin by market cap. Backed by a mix of cash, cash equivalents, and other assets.",
      keyPoints: [
    ...
    },
    {
      ...
      description: "A synthetic dollar that generates yield from ETH staking and perpetual futures funding rates.",
      keyPoints: [
    ...
    },
    {
      ...
      riskLevel: "medium" as const,
      description: "Curve's native stablecoin using LLAMMA for soft liquidations. Innovative but complex.",
      keyPoints: [
...
export const securityContent = {
  ...
  points: [
    {
      title: "Non-Custodial",
      description: "We never hold your funds. Your assets stay in your wallet, controlled only by you.",
      icon: "Lock"
    },
    {
      title: "Smart Contract Audits",
      description: "All protocols we integrate with have undergone multiple security audits by top firms.",
      icon: "CheckCircle"
    },
    {
      title: "Open Source",
      description: "Our entire codebase is open source. You can verify every line of code.",
      icon: "Code"
    },
    {
      title: "No Seed Phrases",
      description: "We use Thirdweb's in-app wallet with social login. Your wallet is secured by your Google account.",
      icon: "Shield"
    }
  ],
