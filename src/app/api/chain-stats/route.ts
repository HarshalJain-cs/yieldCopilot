...
// Alchemy RPC URL
const ALCHEMY_RPC_URL = process.env.ALCHEMY_RPC_URL || "https://eth-mainnet.g.alchemy.com/v2/demo";
...
export async function GET() {
    ...
    try {
        ...
        const gasPriceWei = gasPriceData.result ? parseInt(gasPriceData.result, 16) : 25000000000;
