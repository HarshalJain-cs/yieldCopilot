...
export function LiveChainStats({ className = "", refreshInterval = 5000 }: LiveStatsProps) {
    ...
    return (
        <div className={`${className} text-center py-4`}>
            ...
            <p className="text-[var(--muted-foreground)] text-xs mb-6">
                {stats.subBlockLatency} sub-blocks<br />
            ...
            <div className="flex flex-wrap items-start justify-center gap-12 md:gap-16 mb-4">
                ...
                <div className="text-center">
                    <div className="flex items-center justify-center gap-1.5 mb-1">
                        ...
                        <span className="text-[var(--muted-foreground)] text-xs">Transactions</span>
                    </div>
                    <p className="text-2xl md:text-3xl font-bold text-[var(--foreground)] font-mono">
                        {transactionBase.toLocaleString()}<CountingLastDigit />
                    </p>
                </div>
                ...
                <div className="text-center">
                    <div className="flex items-center justify-center gap-1.5 mb-1">
                        <span className="w-1.5 h-1.5 rounded-full bg-green-400" />
                        <span className="text-[var(--muted-foreground)] text-xs">Smart Contracts</span>
                    </div>
                    <p className="text-2xl md:text-3xl font-bold text-[var(--foreground)] font-mono">
                ...
                <div className="text-center">
                    <div className="flex items-center justify-center gap-1.5 mb-1">
                        <span className="w-1.5 h-1.5 rounded-full bg-green-400" />
                        <span className="text-[var(--muted-foreground)] text-xs">Wallets</span>
                    </div>
                    <p className="text-2xl md:text-3xl font-bold text-[var(--foreground)] font-mono">
